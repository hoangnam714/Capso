...
[![GitHub stars](https://img.shields.io/github/stars/hoangnam714/Capso?style=social)](https://github.com/hoangnam714/Capso/stargazers)
...
<p align="center">
  <a href="https://github.com/hoangnam714/Capso/releases/latest"><strong>Download &rarr;</strong></a> &nbsp;&bull;&nbsp;
  <a href="https://x.com/hoangnam714">Follow @hoangnam714</a> &nbsp;&bull;&nbsp;
...
Grab the latest signed, notarized DMG from [**GitHub Releases →**](https://github.com/hoangnam714/Capso/releases/latest)

Or install via Homebrew:

```bash
brew tap hoangnam714/tap
...
# Clone and build
git clone https://github.com/hoangnam714/Capso.git
cd Capso
xcodegen generate
...
See [open issues](https://github.com/hoangnam714/Capso/issues) for current priorities and [GitHub Releases](https://github.com/hoangnam714/Capso/releases) for version history. Contributions welcome!
...
- [Report a bug](https://github.com/hoangnam714/Capso/issues/new?template=bug_report.yml)
- [Request a feature](https://github.com/hoangnam714/Capso/issues/new?template=feature_request.yml)
- [Follow @hoangnam714 on X](https://x.com/hoangnam714) for release notes and behind-the-scenes updates

If Capso saves you time, a small tip keeps it growing — every bit funds more polish, more features, fewer bugs.

<p align="center">
  <a href="https://x.com/hoangnam714">
    <img src="https://img.shields.io/badge/Follow-@hoangnam714-000000?style=for-the-badge&logo=x&logoColor=white" alt="Follow @hoangnam714 on X" />
  </a>
  &nbsp;
